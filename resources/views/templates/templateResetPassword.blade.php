...
<html lang="en">
	...
	<body id="bodyLogin">
		...
		@endif
		<form id = "formularioLogin" action="/reset-password" method="POST" class=" col-md-6 offset-md-3 ">
		  
			<div id = "loginContainer" class="Logincontainer form-group" >
				<h3 class="mb-4 text-center font-semibold text-gray-600 dark:text-gray-300" >
					Alterar Senha
				</h3>
