				...
				@foreach ($decks as $deck)
					<tr class="text-gray-700 dark:text-gray-400">
					  ...
					  <td class="px-4 py-3 text-sm">
							...
							<div>
							<a data-fancybox data-type="iframe" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="/cardsdeck?deck={{ $deck->id }}">Cards</a>
